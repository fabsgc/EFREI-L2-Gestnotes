...
$request = array();
$request['action'] = 'editTeacher';
$request['controller'] = 'adminTeacher';
$request['logged'] = '1';
$request['name'] = 'admin-teacher-edit';
$request['url'] = '/admin/teacher/edit/([a-z0-9]+)/(.*)(/*)';
$title = 'Éditer un professeur';
$filAriane = 'Professeur/Éditer la fiche d\'un élève/Georges - Teller';
$teacher = array(); 
$teacher['id'] = 'teacher2';
